      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <td class="px-4 py-3 text-sm">
                    <a href="{{ route('producto.show', $producto) }}" class="text-sm dark:text-white hover:underline">
                    {{ $producto->titulo }}
                    </a>
                    </td>
            ...
            <td class="px-4 py-3 text-sm">
            <p class="font-semibold"> $ {{ $producto->precioU }}</p>
            </td>
            <td class="px-4 py-3 text-sm">
            <p class="font-semibold"> $ {{ $producto->precioV }}</p>
            </td>
            <td class="px-4 py-3 text-sm">
            <p class="font-semibold"> $ {{ $producto->cantidadP }}</p>
            </td>
                  @endforeach
                    </tbody>
                 </table>
